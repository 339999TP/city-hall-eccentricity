export const CITIES = [
  ...
  },
  {
    ...
    parliament: { lat: 48.8623,  lon:  2.3188,   name: "Assemblée Nationale" },
  ...
  },
  {
    ...
    zero:       { lat: 37.5759,  lon: 126.9769,  name: "Gwanghwamun Intersection (doro wonpyo)" },
  ...
  },
  {
    ...
    zero:       { lat: 40.7678,  lon: -73.9816,  name: "Columbus Circle (zero mile)" },
    parliament: null, leader: null,
  },
  {
  ...
  },
  {
    ...
    zero:       { lat: 37.7793,  lon: -122.4156, name: "UN Plaza (Civic Center)" },
    parliament: null, leader: null,
  },
  {
  ...
  },
  {
    ...
    zero:       { lat: 41.8933,  lon: 12.4828,   name: "Kilometre Zero (Campidoglio)" },
